            ...
            >
                <div class="{formContainer} col-start-1">
                    <form class="{form} {visibilityLogin}">
                        ...
                        <p
                            class="inline-flex items-center p-0 mt-5 -mb-7 text-primary scale-125"
                        >
                            <input
                                type="checkbox"
                                bind:checked={rememberMe}
                                id="rememberMeLabel"
                                class="appearance-none bg-background border-2 border-solid border-accentNotActive rounded w-8 h-8 cursor-pointer relative scale-50 checked:bg-accent checked:border-accent checked:after:content-['✓'] checked:after:text-background checked:after:absolute checked:after:-top-1 checked:after:left-1 transition-all"
                            />
                            <label
                                for="rememberMeLabel"
                                class="text-accentNotActive text-lg relative left-0 top-0"
                                >Remember me</label
                            >
                        </p>
                        ...
                        {#if state == "login" && alerts.alertLogin == true}
                            <p
                                class="font-basic text-lg mt-10 -mb-5 text-red-600 animate-pulse"
                            >
                                {alerts.alertMessage}
                            </p>
                        {/if}
                ...
                <div class="{formContainer} col-start-2">
                    <form class="{form} {visibilityRegister}">
                        ...
                        <label
                            for="passwordRegisterConfirm"
                            class="{label} {passLabelRegisterConfirm} -left-2"
                        >
                            <svg
                                class={svg}
                                width="46"
                        ...
                        {#if state == "register" && alerts.alertRegister == true}
                            <p
                                class="font-basic text-lg mt-6 -mb-5 text-red-600 animate-pulse"
                            >
                                {alerts.alertMessage}
                            </p>
                        {:else if state == "register" && alerts.successRegister == true}
                            <p
                                class="font-basic text-lg mt-6 -mb-5 text-accent animate-pulse"
                            >
                                {alerts.alertMessage}
                            </p>
                        {:else}
                            <p
                                class="font-basic text-lg mt-6 -mb-5 text-accent animate-pulse select-none"
                            >
                                &nbsp;
                            </p>
                        {/if}
                ...
                >
                    {#if state == "login"}
                        <p
                            class="text-background font-basic text-5xl text-center"
                        >
                            Do you want to register?
                        </p>
                        <p
                            class="text-third font-basic text-xl text-center w-[80%] mt-8"
                        >
                            You will get access to many interesting features,
                            and the registration process will only take a
                            moment. Click the button below
                        </p>
                        <button
                    ...
                    {:else}
                        ...
                        <p
                            class="text-third font-basic text-xl text-center w-[80%] mt-8"
                        >
                            Click the button below to go to login page, and get
                            access to your acconunt in just a while
                        </p>
                        <button
                            class="bg-none border-2 border-solid border-third rounded-xl text-third p-2 pb-3 cursor-pointer relative top-10 scale-125 transition-all hover:bg-accent hover:border-accent hover:text-background"
                            on:click={slider}
